                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.5" min="0" class="form-control @error('days_allowed') is-invalid @enderror" id="days_allowed" name="days_allowed" value="{{ old('days_allowed', 0) }}" required>
                            @error('days_allowed')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
