        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.leave_types.update', $leaveType->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="days_allowed" name="days_allowed" value="{{ old('days_allowed', $leaveType->days_allowed) }}" min="1" required>
                </div>
                
                <div class="mb-3">
                    <label for="color" class="form-label">Color</label>
                    <input type="color" class="form-control form-control-color" id="color" name="color" value="{{ old('color', $leaveType->color) }}" title="Choose a color for this leave type">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="requires_approval" name="requires_approval" value="1" {{ old('requires_approval', $leaveType->requires_approval) ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $leaveType->is_active) ? 'checked' : '' }}>
