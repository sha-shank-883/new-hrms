...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('admin.employees.edit', $employee->id) }}" class="btn btn-sm btn-primary shadow-sm">
            ...
            <div class="card shadow h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-7">${{ number_format($employee->salary, 2) }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-12 mb-4">
            <div class="card shadow h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('admin.leave-requests.index', ['employee_id' => $employee->id]) }}" class="btn btn-sm btn-info mr-2">
                            <i class="fas fa-calendar-alt fa-sm"></i> View Leave Requests
                        </a>
                        <a href="{{ route('admin.attendances.index', ['employee_id' => $employee->id]) }}" class="btn btn-sm btn-success">
